...
#test_check("asremlPlus", filter = "42EstimateV") #need to run individual tests
...
#test_check("asremlPlus", filter = "42REMLRTIC") #need to run individual tests
...
#test_check("asremlPlus", filter = "42WheatSpatialVignette") #need to run individual tests
